...
public class CustomEntity {
    ...
    //for DailyIncome
    public CustomEntity( LocalDate orderDate,String itemCode, String description, double unitPrice, int orderQty, double discount,double total) {
    ...
    public CustomEntity(LocalDate orderDate, String itemCode, double unitPrice, int orderQty, double discount,double total) {
        this.itemCode = itemCode;
        this.unitPrice = unitPrice;
        this.orderQty = orderQty;
        this.discount = discount;
